// ======================================================================
// BT.v generated from TopDesign.cysch
// 04/28/2018 at 16:42
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("49afb813-27dc-4950-bfcf-d518194586d2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("bc6f41e4-90fa-4f52-921b-38671d83bd50"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("b6d62312-4c75-4499-b82b-5a5919c4e2de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("333333333.333333"),
		  .is_direct(0),
