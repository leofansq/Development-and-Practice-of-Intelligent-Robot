...
module CharLCD_v2_10_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("75dc1135-c1fc-43eb-8cc5-deca9300ed06/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// TCPWM_P4_v2_0(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=3000, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=60000, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=TCPWM_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_L, CY_INSTANCE_SHORT_NAME=PWM_L, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=PWM_L, )
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0"
`include "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0\or_v1_0.v"
`else
`define CY_BLK_DIR "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0"
`include "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0\or_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0"
`include "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0"
`include "D:\Program File\PSOCCreator\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__Bumper_L_net;
	wire [0:0] tmpFB_0__Bumper_L_net;
	wire [0:0] tmpIO_0__Bumper_L_net;
	wire [0:0] tmpINTERRUPT_0__Bumper_L_net;
	electrical [0:0] tmpSIOVREF__Bumper_L_net;
	...
	cy_psoc3_pins_v1_10
		...
		Bumper_L
		 (.oe(tmpOE__Bumper_L_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bumper_L_net[0:0]}),
		  .io({tmpIO_0__Bumper_L_net[0:0]}),
		  .siovref(tmpSIOVREF__Bumper_L_net),
		  .interrupt({tmpINTERRUPT_0__Bumper_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bumper_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_0_1 PWM_R (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__PWM_OUT_R_net;
	wire [0:0] tmpFB_0__PWM_OUT_R_net;
	wire [0:0] tmpIO_0__PWM_OUT_R_net;
	wire [0:0] tmpINTERRUPT_0__PWM_OUT_R_net;
	electrical [0:0] tmpSIOVREF__PWM_OUT_R_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_OUT_R
		 (.oe(tmpOE__PWM_OUT_R_net),
		  .y({Net_45}),
		  .fb({tmpFB_0__PWM_OUT_R_net[0:0]}),
		  .io({tmpIO_0__PWM_OUT_R_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_OUT_R_net),
		  .interrupt({tmpINTERRUPT_0__PWM_OUT_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_OUT_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_0_2 PWM_L (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__PWM_OUT_L_net;
	wire [0:0] tmpFB_0__PWM_OUT_L_net;
	wire [0:0] tmpIO_0__PWM_OUT_L_net;
	wire [0:0] tmpINTERRUPT_0__PWM_OUT_L_net;
	electrical [0:0] tmpSIOVREF__PWM_OUT_L_net;

	cy_psoc3_pins_v1_10
		#(.id("24cbe245-c51f-4cca-9502-29287091330d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_OUT_L
		 (.oe(tmpOE__PWM_OUT_L_net),
		  .y({Net_72}),
		  .fb({tmpFB_0__PWM_OUT_L_net[0:0]}),
		  .io({tmpIO_0__PWM_OUT_L_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_OUT_L_net),
		  .interrupt({tmpINTERRUPT_0__PWM_OUT_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_OUT_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Bumper_R_net;
	wire [0:0] tmpIO_0__Bumper_R_net;
	wire [0:0] tmpINTERRUPT_0__Bumper_R_net;
	electrical [0:0] tmpSIOVREF__Bumper_R_net;

	cy_psoc3_pins_v1_10
		#(.id("a72c9606-ca36-437e-b095-3b4e65a55218"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Bumper_R
		 (.oe(tmpOE__Bumper_R_net),
		  .y({1'b0}),
		  .fb({Net_110}),
		  .io({tmpIO_0__Bumper_R_net[0:0]}),
		  .siovref(tmpSIOVREF__Bumper_R_net),
		  .interrupt({tmpINTERRUPT_0__Bumper_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bumper_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__POT_L_net;
	wire [0:0] tmpFB_0__POT_L_net;
	wire [0:0] tmpIO_0__POT_L_net;
	wire [0:0] tmpINTERRUPT_0__POT_L_net;
	electrical [0:0] tmpSIOVREF__POT_L_net;

	cy_psoc3_pins_v1_10
		#(.id("bd9380fd-b3b7-47c9-86d5-527166a40e21"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		POT_L
		 (.oe(tmpOE__POT_L_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POT_L_net[0:0]}),
		  .analog({Net_345}),
		  .io({tmpIO_0__POT_L_net[0:0]}),
		  .siovref(tmpSIOVREF__POT_L_net),
		  .interrupt({tmpINTERRUPT_0__POT_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POT_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__POT_R_net;
	wire [0:0] tmpFB_0__POT_R_net;
	wire [0:0] tmpIO_0__POT_R_net;
	wire [0:0] tmpINTERRUPT_0__POT_R_net;
	electrical [0:0] tmpSIOVREF__POT_R_net;
	...
	cy_psoc3_pins_v1_10
		...
		POT_R
		 (.oe(tmpOE__POT_R_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POT_R_net[0:0]}),
		  .analog({Net_392}),
		  .io({tmpIO_0__POT_R_net[0:0]}),
		  .siovref(tmpSIOVREF__POT_R_net),
		  .interrupt({tmpINTERRUPT_0__POT_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POT_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
